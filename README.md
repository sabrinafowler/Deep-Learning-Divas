...
- `Cross_Modal_Autoencoder.ipynb`: Sabrina's cross-modal architecture, separating encoders and decoders for each modality (loads `.npy` feature files generated by `Feature_Extraction_Batch.ipynb`)
